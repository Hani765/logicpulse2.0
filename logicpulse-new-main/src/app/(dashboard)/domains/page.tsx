...
export const metadata: Metadata = {
  title: "Domains | LogicPulse",
  description: "Manage and track your domains in one convenient location.",
};
...
const Users: React.FC<UserProps> = async ({ searchParams }) => {
  ...
  const pageEndPoint = `${API_URL}${DOMAIN}`;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="hidden text-sm text-gray-500 sm:block">
              Manage and track your domains in one convenient location.
            </p>
          </div>
          <DateRangePicker />
        </div>
