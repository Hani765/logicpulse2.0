...
export const metadata: Metadata = {
  title: "Networks | LogicPulse",
  description: "Manage and track your networks in one convenient location.",
};
...
const Users: React.FC<UserProps> = async ({ searchParams }) => {
  ...
  const pageEndPoint = `${API_URL}${NETWORKS}`;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="hidden text-sm text-gray-500 sm:block">
              Manage and track your networks in one convenient location.
            </p>
          </div>
          <DateRangePicker />
        </div>
