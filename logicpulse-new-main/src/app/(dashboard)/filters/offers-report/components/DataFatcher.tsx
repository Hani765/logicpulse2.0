...
const DataFetcher: React.FC<DataFetcherProps> = async ({ token, endPoint, role, pageEndPoint }) => {
    ...
    return <Table token={token} data={response.data} endPoint={pageEndPoint} role={role} />;
};
